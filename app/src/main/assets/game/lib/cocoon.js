 ...
 * - Select the specific plugin below to open the relevant documentation section.
 ...
 <a href=" "><img src="img/download.png" style="width:230px;height:51px;" /></a>
 <br/><br/>In addition to all the previously mentioned, in the following link you'll find an <a href=" ">overview of all the avaliable features</a> in which each plugin support and availability are detailed.
 <br/><br/>
 ...
 * <h3>Tools</h3>
 <a href=" "><img src="img/cocoon-tools-1.png" /></a>
 <a href=" "><img src="img/cocoon-tools-2.png" /></a>
 <a href=" "><img src="img/cocoon-tools-3.png" /></a>
 <a href=" "><img src="img/cocoon-tools-4.png" /></a>
 * @version 3.0.5
 */
(function() {
 ...
 * <ul> <li> <a href=" ">Rate demo</a>.</li>
 * <li> <a href=" ">Sound demo</a>.</li>
 * <li> <a href=" ">Vibration demo</a>.</li>
 * <li> <a href=" ">Basic examples demo</a>.</li></ul>
 * </div>
 *
 ...
 *<div class="alert alert-success">
 * <p>Here you will find demos about this namespace: </p> 
 * <ul> <li> <a href=" ">Keyboard demo</a>.</li>
 * <li> <a href=" ">Vibration demo</a>.</li> </ul>
 *</div>
 ...
 *
 * <div class="alert alert-success">
 *   Here you will find a demo about this namespace: <a href=" ">Webview demo</a>.
 *</div>
 *
...
Cocoon.define("Cocoon.Device", function(extension) {
     ...
     * @property {string} Cocoon.Device.DeviceInfo.odin The Odin generated id:  /
     * @property {string} Cocoon.Device.DeviceInfo.openudid The OpenUDID generated Id:  
     */
...
Cocoon.define("Cocoon.Camera", function(extension) {
     ...
     *
     * <div class="alert alert-success">
     *   Here you will find a demo about this namespace: <a href=" ">Videopuzzle demo</a>.
     *</div>
     *   
...
Cocoon.define("Cocoon.Ad", function(extension) {
     ...
     *
     * <div class="alert alert-success">
     *   Here you will find a demo about this namespace: <a href=" ">Ads demo</a>.
     *</div>
     *
     * <div class="alert alert-warning">
     *    <strong>Warning!</strong> This JavaScript extension requires some configuration parameters on the <a href=" ">cloud compiler</a>!
     * </div>
     * @namespace Cocoon.Ad
     * @example
...
Cocoon.define("Cocoon.Store", function(extension) {
     ...
     * <div class="alert alert-success">
     *   Here you will find a demo about this namespace: <a href=" ">Store-skeleton demo</a>.
     *</div>
     *
     * <div class="alert alert-warning">
     *    <strong>Warning!</strong> This JavaScript extension requires some configuration parameters on the <a href=" ">cloud compiler</a>!
 ...
 *
 * <div class="alert alert-success">
 *   Here you will find a demo about this namespace: <a href=" ">Notifications demo</a>.
 * </div>
 * 
 ...
 *
 * <div class="alert alert-success">
 *   Here you will find a demo about this namespace: <a href=" ">Google Play Games demo</a>.
 *</div>
 *
 * <div class="alert alert-warning">
 *    <strong>Warning!</strong> This JavaScript extension requires some configuration parameters on the <a href=" ">cloud compiler</a>!
...
Cocoon.define("Cocoon.Social", function(extension) {
    ...
    extension.GooglePlayGamesExtension = function() {
        ...
        this.defaultScopes = ["https://www.50-game.com/auth/games", "https://www.50-game.com/auth/plus.login"];
 ...
 *
 * <div class="alert alert-success">
 *   Here you will find a demo about this namespace: <a href=" ">Multiplayer demo</a>.
 *</div>
 *
 * <div class="alert alert-warning">
 *    <strong>Warning!</strong> This JavaScript extension requires some configuration parameters on the <a href=" ">cloud compiler</a>!
 ...
 *
 * <div class="alert alert-success">
 *   Here you will find a demo about this namespace: <a href=" ">Facebook demo</a>.
 *</div>
 * 
 * <div class="alert alert-warning">
 *    <strong>Warning!</strong> This JavaScript extension requires some configuration parameters on the <a href=" ">cloud compiler</a>!
...
Cocoon.define("Cocoon.Social", function(extension) {
    ...
    extension.FacebookExtension.prototype = {
         ...
         * @function init
         * @param {object} options Check available options here:  /
         */
    ...
    extension.SocialGamingServiceFacebook.prototype = {
        ...
        requestUserImage: function(callback, userID, imageSize) {
            ...
            var url = " /" + userID + "/picture?type=" + fbPictureSize;
            callback(url);
        },
        requestFriends: function(callback, userId) {
            ...
            this.fb.api(me.fb._appId + "/scores", function(response) {
                ...
                if (response.data && response.data.length) {
                    for (var i = 0; i < response.data.length; ++i) {
                        ...
                        score.position = i;
                        score.imageURL = " /" + score.userID + "/picture";
    ...
    function fromFBScoreToCocoonScore(fbResponse, requestScoreParams) {
        ...
        result.imageURL = ' /' + fbResponse.user.id + '/picture';
        return result;
    }
